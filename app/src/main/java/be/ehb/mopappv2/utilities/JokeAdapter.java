...
public class JokeAdapter extends RecyclerView.Adapter<JokeAdapter.JokeViewHolder> {
    ...
    public void onBindViewHolder(@NonNull JokeViewHolder jokeViewHolder, int i) {
        Joke jokeVoorDeRij = jokeItems.get(i);

        String dateAsString = Convertor.stringFromDate(jokeVoorDeRij.getPublishDate());

        jokeViewHolder.tvDate.setText(dateAsString);
        jokeViewHolder.tvJoke.setText(jokeVoorDeRij.getJokeText());
